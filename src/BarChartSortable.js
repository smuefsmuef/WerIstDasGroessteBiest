...
//lifeQuality = FileAttachment("./data/data_test.csv").csv({typed: true})
...
const lifeQuality = d3.csv("./data/data_test.csv").then(function(data) {
    console.log(data);
});


chart = BarChartSortable(lifeQuality, {
    x: d => d.country,
    y: d => d.life_quality,
    yFormat: "Index",
    yLabel: "↑ Lebensqualität",
    width:1000,
    height: 500,
    color: "steelblue",
...
update = chart.update(d3.sort(order))